...
def mine_block():
    ...
    blockchain.add_transactions(sender = node_address, receiver = 'Yash', amount = 1)     # Transaction as a reward to the miner, here 'Yash'.
...
app.run(host = '0.0.0.0' , port = 8001)                # PORT 8001
